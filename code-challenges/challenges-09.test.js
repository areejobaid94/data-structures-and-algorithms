...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((total,ele)=>{
    return total + ele.purchasePrice;
  },0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((finalArr,ele)=>{
    finalArr.push(ele.name);
    return finalArr;
  },[]);
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce((finalStr,ele)=>{
    return ele + finalStr;
  },'');
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce((total,ele)=>{
    return ele.children ? ele.children.length + total:total;
  },0);
};
...
const countPrimeNumbers = (arr) => {
  ...
  return arr.reduce((count, ele)=>{
    return isPrime(ele) ? count + 1 : count;
  },0)
};
...
const extractStat = (statName, arr) => {
  ...
  return arr.reduce((obj, ele) =>{
    return ele.stat.name == statName ? ele : obj;
  },null)
};
...
const extractChildren = (arr) => {
  ...
  return arr.filter(ele=>{
    return /a/g.test(ele.name);
  }).reduce((finalArr,ele)=>{
    return ele.children ? finalArr.concat(ele.children) : finalArr;
  },[])
};
