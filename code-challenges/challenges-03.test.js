...
const sortNames = (arr) => {
  // Solution code here...
  return arr.sort((a,b) => lower(a) > lower(b) ? -1 : lower(a) < lower(b) ? 1 : 1)
};
...
const sortNumbers = (arr) => {
  // Solution code here...
  return arr.sort((a,b) =>a > b ? 1 : (a < b) ? -1 : 1)
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  return arr.sort((a,b) => a.price > b.price ? 1 : (a.price < b.price) ? -1 : 1);
};
...
const sortByLength = (arr) => {
  // Solution code here...
  return arr.sort((a,b) => a.length > b.length ? 1 : a.length < b.length ? -1 : 1);
};
...
const sortNumbersByLength = (arr) => {
  // Solution code here...
  return arr.sort((a,b) => String(a).length > String(b).length ? 1 : String(a).length < String(b).length ? -1 : 1);
};
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((a,b) => a.lastName > b.lastName ? 1 : (a.lastName < b.lastName) ? -1 : 1);
};
